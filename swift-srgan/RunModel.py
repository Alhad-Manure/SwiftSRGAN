...
# ---------- CONFIGURATION ----------
IMAGE_PATH = r'D:\\Mtech\\Sem2\\Mini_Project\\SRGAN\\Trainings\\Training2\\Results\\TestImgPairs\\Test1.JPG'       # Change to your input image
MODEL_PATH = 'model.pt'        # Change to your .pt model path
OUTPUT_PATH = r'D:\\Mtech\\Sem2\\Mini_Project\\SRGAN\\Trainings\\Training2\\Results\\TestImgPairs\\Test12Output.JPG'     # Output image path
...
transform_input = transforms.Compose([
    ...
    transforms.Resize(128, interpolation=Resampling.BICUBIC),
    transforms.ToTensor()
])
...
model = Generator()
checkpoint = torch.load(r'D:\\Mtech\\Sem2\\Mini_Project\\SRGAN\\Trainings\\Training2\\Results\\Models\\netG_4x_epoch245.pth.tar', map_location=DEVICE)
